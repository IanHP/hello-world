"""
Steps:
1. Read the file and turn it into 1 massive string
2. split into different lists (each index = 1 k:v pair)
3. Split each list into another list (list of list), seperating key and value
4. Ensure that the key and value have correct syntax, no repeats, ect.
